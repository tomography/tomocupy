...
fp16 = dxchange.read_tiff('res/lfp16.tiff').astype('float32')/2048/2048#*0.94
fp32 = dxchange.read_tiff('res/lfp32.tiff').astype('float32')/2048/2048
...
ax0.set_title('Log-polar, 32-bit')
...
ax0.set_title('Log-polar, 16-bit')
...
ax0.set_title('Log-polar, difference')
