...
cmd_dict = {
    f'{prefix} --reconstruction-type try --center-search-width 10 --lamino-angle 1 --reconstruction-algorithm linerec': 14.023,
    f'{prefix} --reconstruction-type try_lamino --lamino-angle 1 --reconstruction-algorithm linerec': 37.060,
    f'{prefix} --reconstruction-type try --center-search-width 10 --rotate-proj-angle 1 --nsino [0,0.5]': 28.004,
    f'{prefix} --reconstruction-type try --center-search-width 10 --lamino-angle 1 --rotate-proj-angle 1 --nsino [0,0.5]': 26.180,    
    f'{prefix} --reconstruction-type try --center-search-width 10  --binning 1 --rotate-proj-angle 1 --nsino [0,0.5]': 11.103,    
}
