...
tomocupy recon_steps --file-name /local/ssd/data/tomo_00002.h5 --remove-stripe-method fw --retrieve-phase-method paganin --reconstruction-type full --start-row 900 --end-row 1000
tomocupy recon_steps --file-name /local/ssd/data/tomo_00002.h5 --remove-stripe-method fw --retrieve-phase-method paganin --reconstruction-type full --save-format h5 --start-row 900 --end-row 1000
tomocupy recon_steps --file-name /local/ssd/data/tomo_00002.h5 --remove-stripe-method fw --retrieve-phase-method paganin --reconstruction-type full --file-type double_fov --nsino-per-chunk 4 --start-row 900 --end-row 1000