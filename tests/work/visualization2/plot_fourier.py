...
s1=ssim(fp16*1000*circ,fp32*1000*circ)
...
ax0.set_title('FourierRec, 32-bit')
...
ax0.set_title('FourierRec, 16-bit')
...
ax0.set_title('FourierRec, difference')
...
plt.colorbar(im, cax=cax,format='%.0e')
plt.savefig('FourierRec_fp32_16.png',dpi=300,bbox_inches='tight')