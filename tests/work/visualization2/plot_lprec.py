...
fp16 = dxchange.read_tiff('res/lfp16.tiff').astype('float32')
fp32 = dxchange.read_tiff('res/lfp32.tiff').astype('float32')

s1=ssim(fp16*circ*1000,fp32*circ*1000)
# print(ssim(fp32f*1000,fp32tpad*1000))
# exit()
...
ax0.set_title('LpRec, difference')
...
plt.colorbar(im, cax=cax,format='%.0e')
plt.savefig('LpRec_fp32_16.png',dpi=300,bbox_inches='tight')